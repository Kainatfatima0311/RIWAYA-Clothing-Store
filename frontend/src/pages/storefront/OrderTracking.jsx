...
export default function OrderTracking() {
  ...
  return (
    <div className="container py-8 max-w-3xl">
      <h1 className="font-serif text-3xl md:text-4xl mb-6 animate-fade-up">Track your order</h1>
                  ...
                  <div className="flex flex-wrap items-center gap-3">
                    ...
                    {data.data.courier.trackingUrl && (
                      <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className="text-sm text-primary font-medium transition-colors hover:text-primary-hover"
                      >
                        View on courier →
                      </a>
                    )}
